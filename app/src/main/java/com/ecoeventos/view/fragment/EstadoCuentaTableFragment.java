...
public class EstadoCuentaTableFragment extends Fragment {

	private List<EstadoCuentaDTO> estadoDTOs;
	private TableLayout mTableLayout;

	public EstadoCuentaTableFragment() {
        super();
	}
	...
	public void onResume() {
		super.onResume();
		((EstadoCuentaActivity)getActivity()).addMoreItemsToFill();
	}
	...
	public void onStart() {
		super.onStart();
		if(((EstadoCuentaActivity) getActivity()).getmScrollView().canScrollVertically(1))
			((EstadoCuentaActivity) getActivity()).addMoreItemsToFill();
	}
